...
public class PaymentService {
     ...
     */
    @Transactional
    public void saveUsageHistory(String email, Long amount, Reservation reservation, String paymentType) { // 📍 이름을 paymentType으로 변경
        if (reservation == null) {
        ...
        Payment payment = Payment.builder()
                .email(email)
                .amount(amount)
                .paymentType(paymentType) // 📍 이제 빨간 줄이 사라집니다!
